...
# your solution here
#A
long_logarray = np.logspace(np.log10(.1), np.log10(10000), 10)
print(long_logarray)
#B
first_val=long_logarray[0]
fin_val=long_logarray[-1]
bw_5_8=long_logarray[5:8]
print(first_val,fin_val,bw_5_8)
#C
appended_log=[long_logarray, [10001,10002]]
print(appended_log)
#D
print(long_logarray/2)
#E
reshaped_log=(long_logarray/2).reshape(2,5)#Can not reshape to (3,4) because this array is size 10
print(reshaped_log)
#F
print((reshaped_log)*(reshaped_log))
#G
numDim=reshaped_log.ndim
maxVal=np.max(reshaped_log)
print(numDim, maxVal)
